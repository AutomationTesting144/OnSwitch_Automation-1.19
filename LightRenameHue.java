...
public class LightRenameHue {
    ...
    public void LightRenameHue (AndroidDriver driver, String fileName, String APIVersion, String SWVersion) throws IOException, JSONException, InterruptedException  {
        ...
        {
            Status = "1";
            ActualResult = "Light " + lightName + " is renamed to: "+ LightNameAfter+ " and added and controlled by group";
            Comments = "NA";
            ExpectedResult= "Light " + lightName + " should be renamed to: "+ LightNameAfter+ " and should be added and controlled by group";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
        } else {
            Status = "0";
            ActualResult = "Light " + lightName + " is not renamed to: "+ LightNameAfter+ " and is not added and controlled by group";
